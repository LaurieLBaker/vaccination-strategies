...
* How many vaccination campaigns does it take to eliminate infection?
...
### Where should we drop vaccines?
  * Geographically
  * Timing: Spring, Autumn
  
### What happens when things go wrong?
  * Impact of missed vaccination campaign sets
...
* Incomplete vaccination compromised time to elimination.

* Requiring the same or more effort to achieve similar vaccination timelines.

* Autumn campaigns post-birth pulse were most important.
...
### 1. Disease like rabies don't respect borders.

--

### 2. Consecutive and coordinated vaccination is required to rapidly control and eliminate rabies.

--

### 3. It is important to take into account population dynamics and  ecology of the species.

--

### 4. Policymakers need to commit to full elimination timelines and maintain comprehensive coverage to eliminate the disease.
